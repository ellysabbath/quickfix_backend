...
# # registration/models.py - Add this new model
...
#     customer_request = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='received_quotes')
...
#     customer_request = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='service_appointment')
...
# # =========================// FIX PROVIDERS//================================
# # workshop/models.py - Add Garage model
...
# # ======================= EXISTING MODELS (Keep your existing ones) =======================
# # AutoWorkshop, RepairService, CustomerRequest, etc... (keep them as is)
...
class CustomerServiceRequest(models.Model):
    ...
    transaction = models.OneToOneField(
        'payments.Transaction',  # Link to Transaction model
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
    ...
    def save(self, *args, **kwargs):
        ...
        if self.transaction and self.transaction.payment_status == 'completed':
            self.budget_maximum = self.transaction.amount
